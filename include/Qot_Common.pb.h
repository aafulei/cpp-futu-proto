...
const QotMarket QotMarket_MAX = QotMarket_FX_Security;
...
const QotMarketState QotMarketState_MAX = QotMarketState_OVERNIGHT;
...
const Issuer Issuer_MAX = Issuer_CI;
...
const ExpirationCycle ExpirationCycle_MAX = ExpirationCycle_WeekFri;
...
const OptionStandardType OptionStandardType_MIN = OptionStandardType_Unknown;
const OptionStandardType OptionStandardType_MAX = OptionStandardType_NonStandard;
const int OptionStandardType_ARRAYSIZE = OptionStandardType_MAX + 1;

const ::google::protobuf::EnumDescriptor* OptionStandardType_descriptor();
inline const ::std::string& OptionStandardType_Name(OptionStandardType value) {
  return ::google::protobuf::internal::NameOfEnum(
    OptionStandardType_descriptor(), value);
}
inline bool OptionStandardType_Parse(
    const ::std::string& name, OptionStandardType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<OptionStandardType>(
    OptionStandardType_descriptor(), name, value);
}
...
const OptionSettlementMode OptionSettlementMode_MIN = OptionSettlementMode_Unknown;
const OptionSettlementMode OptionSettlementMode_MAX = OptionSettlementMode_PM;
const int OptionSettlementMode_ARRAYSIZE = OptionSettlementMode_MAX + 1;

const ::google::protobuf::EnumDescriptor* OptionSettlementMode_descriptor();
inline const ::std::string& OptionSettlementMode_Name(OptionSettlementMode value) {
  return ::google::protobuf::internal::NameOfEnum(
    OptionSettlementMode_descriptor(), value);
}
inline bool OptionSettlementMode_Parse(
    const ::std::string& name, OptionSettlementMode* value) {
  return ::google::protobuf::internal::ParseNamedEnum<OptionSettlementMode>(
    OptionSettlementMode_descriptor(), name, value);
}
enum ExchType {
  ExchType_Unknown = 0,
...
const PriceReminderMarketStatus PriceReminderMarketStatus_MIN = PriceReminderMarketStatus_Unknow;
const PriceReminderMarketStatus PriceReminderMarketStatus_MAX = PriceReminderMarketStatus_USOverNight;
const int PriceReminderMarketStatus_ARRAYSIZE = PriceReminderMarketStatus_MAX + 1;

const ::google::protobuf::EnumDescriptor* PriceReminderMarketStatus_descriptor();
inline const ::std::string& PriceReminderMarketStatus_Name(PriceReminderMarketStatus value) {
  return ::google::protobuf::internal::NameOfEnum(
    PriceReminderMarketStatus_descriptor(), value);
}
inline bool PriceReminderMarketStatus_Parse(
    const ::std::string& name, PriceReminderMarketStatus* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PriceReminderMarketStatus>(
    PriceReminderMarketStatus_descriptor(), name, value);
}
// ===================================================================
...
class BasicQot : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_Common.BasicQot) */ {
 public:
  ...
  bool has_overnight() const;
  void clear_overnight();
  static const int kOvernightFieldNumber = 25;
  const ::Qot_Common::PreAfterMarketData& overnight() const;
  ::Qot_Common::PreAfterMarketData* release_overnight();
  ::Qot_Common::PreAfterMarketData* mutable_overnight();
  void set_allocated_overnight(::Qot_Common::PreAfterMarketData* overnight);
 ...
 private:
  ...
  void set_has_overnight();
  void clear_has_overnight();
  ...
  ::Qot_Common::PreAfterMarketData* overnight_;
  double pricespread_;
  double highprice_;
  double openprice_;
  double lowprice_;
...
class OptionStaticExData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_Common.OptionStaticExData) */ {
 public:
  ...
  bool has_expirationcycle() const;
  void clear_expirationcycle();
  static const int kExpirationCycleFieldNumber = 9;
  ::google::protobuf::int32 expirationcycle() const;
  void set_expirationcycle(::google::protobuf::int32 value);

  // optional int32 optionStandardType = 10;
  bool has_optionstandardtype() const;
  void clear_optionstandardtype();
  static const int kOptionStandardTypeFieldNumber = 10;
  ::google::protobuf::int32 optionstandardtype() const;
  void set_optionstandardtype(::google::protobuf::int32 value);

  // optional int32 optionSettlementMode = 11;
  bool has_optionsettlementmode() const;
  void clear_optionsettlementmode();
  static const int kOptionSettlementModeFieldNumber = 11;
  ::google::protobuf::int32 optionsettlementmode() const;
  void set_optionsettlementmode(::google::protobuf::int32 value);
 ...
 private:
  ...
  void set_has_indexoptiontype();
  void clear_has_indexoptiontype();
  void set_has_expirationcycle();
  void clear_has_expirationcycle();
  void set_has_optionstandardtype();
  void clear_has_optionstandardtype();
  void set_has_optionsettlementmode();
  void clear_has_optionsettlementmode();
  ...
  ::google::protobuf::int32 indexoptiontype_;
  ::google::protobuf::int32 expirationcycle_;
  ::google::protobuf::int32 optionstandardtype_;
  ::google::protobuf::int32 optionsettlementmode_;
  friend struct ::protobuf_Qot_5fCommon_2eproto::TableStruct;
...
// optional .Qot_Common.PreAfterMarketData overnight = 25;
inline bool BasicQot::has_overnight() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void BasicQot::set_has_overnight() {
  _has_bits_[0] |= 0x00000200u;
}
inline void BasicQot::clear_has_overnight() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void BasicQot::clear_overnight() {
  if (overnight_ != NULL) overnight_->Clear();
  clear_has_overnight();
}
inline const ::Qot_Common::PreAfterMarketData& BasicQot::overnight() const {
  const ::Qot_Common::PreAfterMarketData* p = overnight_;
  // @@protoc_insertion_point(field_get:Qot_Common.BasicQot.overnight)
  return p != NULL ? *p : *reinterpret_cast<const ::Qot_Common::PreAfterMarketData*>(
      &::Qot_Common::_PreAfterMarketData_default_instance_);
}
inline ::Qot_Common::PreAfterMarketData* BasicQot::release_overnight() {
  // @@protoc_insertion_point(field_release:Qot_Common.BasicQot.overnight)
  clear_has_overnight();
  ::Qot_Common::PreAfterMarketData* temp = overnight_;
  overnight_ = NULL;
  return temp;
}
inline ::Qot_Common::PreAfterMarketData* BasicQot::mutable_overnight() {
  set_has_overnight();
  if (overnight_ == NULL) {
    overnight_ = new ::Qot_Common::PreAfterMarketData;
  }
  // @@protoc_insertion_point(field_mutable:Qot_Common.BasicQot.overnight)
  return overnight_;
}
inline void BasicQot::set_allocated_overnight(::Qot_Common::PreAfterMarketData* overnight) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete overnight_;
  }
  if (overnight) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      overnight = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, overnight, submessage_arena);
    }
    set_has_overnight();
  } else {
    clear_has_overnight();
  }
  overnight_ = overnight;
  // @@protoc_insertion_point(field_set_allocated:Qot_Common.BasicQot.overnight)
}
...
// optional int32 expirationCycle = 9;
inline bool OptionStaticExData::has_expirationcycle() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void OptionStaticExData::set_has_expirationcycle() {
  _has_bits_[0] |= 0x00000100u;
}
inline void OptionStaticExData::clear_has_expirationcycle() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void OptionStaticExData::clear_expirationcycle() {
  expirationcycle_ = 0;
  clear_has_expirationcycle();
}
inline ::google::protobuf::int32 OptionStaticExData::expirationcycle() const {
  // @@protoc_insertion_point(field_get:Qot_Common.OptionStaticExData.expirationCycle)
  return expirationcycle_;
}
inline void OptionStaticExData::set_expirationcycle(::google::protobuf::int32 value) {
  set_has_expirationcycle();
  expirationcycle_ = value;
  // @@protoc_insertion_point(field_set:Qot_Common.OptionStaticExData.expirationCycle)
}

// optional int32 optionStandardType = 10;
inline bool OptionStaticExData::has_optionstandardtype() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void OptionStaticExData::set_has_optionstandardtype() {
  _has_bits_[0] |= 0x00000200u;
}
inline void OptionStaticExData::clear_has_optionstandardtype() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void OptionStaticExData::clear_optionstandardtype() {
  optionstandardtype_ = 0;
  clear_has_optionstandardtype();
}
inline ::google::protobuf::int32 OptionStaticExData::optionstandardtype() const {
  // @@protoc_insertion_point(field_get:Qot_Common.OptionStaticExData.optionStandardType)
  return optionstandardtype_;
}
inline void OptionStaticExData::set_optionstandardtype(::google::protobuf::int32 value) {
  set_has_optionstandardtype();
  optionstandardtype_ = value;
  // @@protoc_insertion_point(field_set:Qot_Common.OptionStaticExData.optionStandardType)
}

// optional int32 optionSettlementMode = 11;
inline bool OptionStaticExData::has_optionsettlementmode() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void OptionStaticExData::set_has_optionsettlementmode() {
  _has_bits_[0] |= 0x00000400u;
}
inline void OptionStaticExData::clear_has_optionsettlementmode() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void OptionStaticExData::clear_optionsettlementmode() {
  optionsettlementmode_ = 0;
  clear_has_optionsettlementmode();
}
inline ::google::protobuf::int32 OptionStaticExData::optionsettlementmode() const {
  // @@protoc_insertion_point(field_get:Qot_Common.OptionStaticExData.optionSettlementMode)
  return optionsettlementmode_;
}
inline void OptionStaticExData::set_optionsettlementmode(::google::protobuf::int32 value) {
  set_has_optionsettlementmode();
  optionsettlementmode_ = value;
  // @@protoc_insertion_point(field_set:Qot_Common.OptionStaticExData.optionSettlementMode)
}
...
template <> struct is_proto_enum< ::Qot_Common::OptionStandardType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Qot_Common::OptionStandardType>() {
  return ::Qot_Common::OptionStandardType_descriptor();
}
template <> struct is_proto_enum< ::Qot_Common::OptionSettlementMode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Qot_Common::OptionSettlementMode>() {
  return ::Qot_Common::OptionSettlementMode_descriptor();
}
...
template <> struct is_proto_enum< ::Qot_Common::PriceReminderMarketStatus> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Qot_Common::PriceReminderMarketStatus>() {
  return ::Qot_Common::PriceReminderMarketStatus_descriptor();
}
