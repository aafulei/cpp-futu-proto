...
class FutureInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_GetFutureInfo.FutureInfo) */ {
 public:
  ...
  const ::Qot_Common::Security& origin() const;
  ::Qot_Common::Security* release_origin();
  ::Qot_Common::Security* mutable_origin();
  void set_allocated_origin(::Qot_Common::Security* origin);
...
// optional .Qot_Common.Security origin = 18;
inline bool FutureInfo::has_origin() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void FutureInfo::set_has_origin() {
  _has_bits_[0] |= 0x00002000u;
}
inline void FutureInfo::clear_has_origin() {
  _has_bits_[0] &= ~0x00002000u;
}
inline const ::Qot_Common::Security& FutureInfo::origin() const {
  const ::Qot_Common::Security* p = origin_;
  // @@protoc_insertion_point(field_get:Qot_GetFutureInfo.FutureInfo.origin)
  return p != NULL ? *p : *reinterpret_cast<const ::Qot_Common::Security*>(
      &::Qot_Common::_Security_default_instance_);
}
inline ::Qot_Common::Security* FutureInfo::release_origin() {
  // @@protoc_insertion_point(field_release:Qot_GetFutureInfo.FutureInfo.origin)
  clear_has_origin();
  ::Qot_Common::Security* temp = origin_;
  origin_ = NULL;
  return temp;
}
inline ::Qot_Common::Security* FutureInfo::mutable_origin() {
  set_has_origin();
  if (origin_ == NULL) {
    origin_ = new ::Qot_Common::Security;
  }
  // @@protoc_insertion_point(field_mutable:Qot_GetFutureInfo.FutureInfo.origin)
  return origin_;
}
inline void FutureInfo::set_allocated_origin(::Qot_Common::Security* origin) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  origin_ = origin;
  // @@protoc_insertion_point(field_set_allocated:Qot_GetFutureInfo.FutureInfo.origin)
}
